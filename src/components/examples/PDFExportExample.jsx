...
function PDFExportExample() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div id="content-to-export" className="bg-card text-card-foreground p-6 border rounded-lg mb-6">
        ...
        <table className="w-full border-collapse border border-border mb-4">
          <thead>
            <tr className="bg-muted">
              <th className="border border-border p-2 text-left">Column 1</th>
              <th className="border border-border p-2 text-left">Column 2</th>
              <th className="border border-border p-2 text-left">Column 3</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="border border-border p-2">Data 1</td>
              <td className="border border-border p-2">Data 2</td>
              <td className="border border-border p-2">Data 3</td>
            </tr>
            <tr>
              <td className="border border-border p-2">Data 4</td>
              <td className="border border-border p-2">Data 5</td>
              <td className="border border-border p-2">Data 6</td>
            </tr>
          </tbody>
        </table>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="border p-4 rounded">
          ...
          <p className="text-sm text-muted-foreground mb-3">Best for complex HTML with styling</p>
          <PDFExportButton
        ...
        <div className="border p-4 rounded">
          ...
          <p className="text-sm text-muted-foreground mb-3">Good for visual content</p>
          <PDFExportButton
            contentId="content-to-export"
        ...
        <div className="border p-4 rounded">
          ...
          <p className="text-sm text-muted-foreground mb-3">Simple text-only PDF</p>
          <PDFExportButton
            method="text"
        ...
        <div className="border p-4 rounded">
          ...
          <p className="text-sm text-muted-foreground mb-3">Structured data tables</p>
          <PDFExportButton
            method="table"
      ...
      <div className="mt-8 p-4 bg-amber-100/40 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 rounded-lg">
